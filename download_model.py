...
def parse_args():
    p = argparse.ArgumentParser(
        description="Download and save a HF model to a local directory."
    )
    p.add_argument(
        "--repo-id",
        type=str,
    ...
    p.add_argument(
        ...
        type=str,
        default=None,
        help="Optional git revision / tag / commit.",
    )
    p.add_argument(
        "--local-files-only",
        action="store_true",
    ...
    p.add_argument(
        ...
        dest="symlinks",
        action="store_true",
        help="Use symlinks (snapshot method).",
    )
    p.add_argument(
        "--no-symlinks",
        dest="symlinks",
        action="store_false",
        help="Copy actual files (snapshot method).",
    )
