...
from cs336_alignment.eval_utils import evaluate_responses
...
TRAIN_MATH_DATASET_PATHS = [
    "data/pre-processed/math/train.jsonl",
    "data/pre-processed/gsm8k/train.jsonl",
]
TEST_MATH_DATASET_PATHS = [
    "data/pre-processed/math/test.jsonl",
    "data/pre-processed/gsm8k/test.jsonl",
]
...
def main():
    ...
    vllm = init_vllm(
        model_id=MODEL_NAME,
        device=str(get_device(rank=0)),
        seed=42,
        gpu_memory_utilization=0.85,
    )

    print("Initialized vLLM finished.")
    ...
    for train_dataset_path, test_dataset_path in zip(
        TRAIN_MATH_DATASET_PATHS, TEST_MATH_DATASET_PATHS
    ):
